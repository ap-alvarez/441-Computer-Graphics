...
public:
    ...
    double xMin() const { return c.x - (s * 0.5f); }
    double xMax() const { return c.x + (s * 0.5f); }
    double yMin() const { return c.y - (s * 0.5f); }
    double yMax() const { return c.y + (s * 0.5f); }
    double zMin() const { return c.z - (s * 0.5f); }
    double zMax() const { return c.z + (s * 0.5f); }
    glm::vec3 center() const { return c; }
};
